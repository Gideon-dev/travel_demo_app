  ...
  return (
    <section className='2xl:max-container relative flex flex-col py-10 lg:py-20 xl:mb-20'>
      <div className='hide-scrollbar flex h-[340px] w-full items-start justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]'>
        ...
        subtitle="Somewhere not in the wilderness"
        peopleJoined= "50k+ joined"
        />
      ...
      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-60">
        <div className="bg-green-50 p-8 lg:max-w-[500px] xl: max-w-[734px] xl:rounded-5xl xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
          ...
          the possibility of getting lost is very large. Thats why we are here for those of you who want to start an adventure.
          </p>
          <Image
          src="/quote.svg"
          alt="camp-2"
